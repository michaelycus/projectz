...
<head>
	...
	<title>Error 500 - Pages - PixelAdmin</title>
...
<script>var init = [];</script>
	...
	<div class="header">
		<a href="index.html" class="logo">
			<div class="demo-logo"><img src="{{ URL::asset('demo/logo-big.png') }}" alt="" style="margin-top: -4px;"></div>&nbsp;
	...
	<div class="error-text">
		...
		<span class="hr"></span>
		<br>
		ALGO NÃO ESTÁ BEM CERTO
		<br>
		<span class="solve">Esperamos corrigir isso rápido</span>
	</div> <!-- / .error-text -->
